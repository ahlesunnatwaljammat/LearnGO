...
func main() {
	...
	pdf.SetHeaderFunc(func() {
		...
		pdf.CellFormat(maxWidth, 5, "Hello, world", "", 0, "C", false, 0, "")
		pdf.Ln(-1)

		pdf.SetFont("Arial", "", 8)
		pdf.CellFormat(maxWidth, 5, "Street addresses: 445 Mount Eden Road, Mount Eden, Auckland", "", 0, "C", false, 0, "")
		pdf.Ln(-1)

		pdf.SetFont("Arial", "B", 8)
		pdf.CellFormat(maxWidth, 7, "Hello, world", "", 0, "C", false, 0, "")
		pdf.Ln(-1)
	})
	...
	if runtime.GOOS == "windows" {
		cmd := exec.Command("F:\\vmdata\\Linux-Softwares\\PDFtoPrinter.exe", "" /*, "HP LaserJet P2055dn UPD PCL 6"*/)
		out, err := cmd.Output()
		if err == nil {
	...
	/*filePath := "E:\\Learning\\go-lang\\workspace\\LearnGO\\hello.pdf"
	imagick.Initialize()
